...
public class GStroke implements Serializable,  FromStringProvider<GStroke> {
    ...
    public static GStroke strong = new GStroke("strong", 3, new float[]{1, 0});
    ...
    public static GStroke dashed_dashed_dotted = new GStroke("dashed-dashed-dotted", 3, new float[]{6, 2, 6, 2, 2, 4});
