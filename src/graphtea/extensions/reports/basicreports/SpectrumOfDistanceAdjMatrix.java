...
public class SpectrumOfDistanceAdjMatrix implements GraphReportExtension<ArrayList<String>> {
    public ArrayList<String> calculate(GraphModel g) {
        ArrayList<String> res = new ArrayList<>();
        res.add("Distance Adjacency Matrix");
    ...
    public String getName() {
        return "Spectrum of Distance Adjacency Matrix";
    }
