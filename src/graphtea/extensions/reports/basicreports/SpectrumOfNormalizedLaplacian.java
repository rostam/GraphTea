...
@CommandAttitude(name = "spectrum_normalized_laplacian", abbreviation = "_snl")
public class SpectrumOfNormalizedLaplacian implements GraphReportExtension<ArrayList<String>> {

    public ArrayList<String> calculate(GraphModel g) {
        ArrayList<String> res = new ArrayList<>();
        res.add("Normalized Laplacian Matrix");
