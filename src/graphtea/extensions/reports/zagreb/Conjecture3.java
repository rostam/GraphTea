...
@CommandAttitude(name = "conj3", abbreviation = "_conj3")
public class Conjecture3 implements GraphReportExtension,Parametrizable {
    public String getName() {
        return "ZIndices of Matching Conjecture 2";
    }
