...
public class Exp implements GraphReportExtension {
  ...
  //    titles.add(" aplpha*e-comp ");
     ...
     //      titles.add(" Dia ");
      ...
      //   titles.add("Girth");
        ...
        double expM21=zif.getexpFirstZagreb(1);
        double expM11=zif.getexpInvEdge(-1);
        double expM12=zif.getexpSecondZagreb(1);
        double expR=zif.getexpSecondZagreb(-0.5);
        double expChi=zif.getexpFirstZagreb(-0.5);
        double expH=zif.getexpHarmonicIndex();
        double expABC=zif.getexpABCindex();
        double expAZI=zif.getexpAugumentedZagrebIndex();
        double expGA=zif.getexpGAindex();
        double expSDD = zif.getexpSDDIndex();
...
//        double Albertson = zif.getAlbertson();
 ...
 //      v.add(expGA);
     ...
     //   v.add(M31);
    // Bala Sir.    
   //     v.add(m*Math.exp(Math.sqrt(m*( n-(2*R1) ) )/m ) );
  //     v.add( expM21 );
  //      v.add( expM11 );
  //      v.add(AZI);
  //      v.add(expAZI);
