   ...
   //     v.add(wi.calculate(AlgorithmUtils.createLineGraph(g))); 
    ...
    //   v.add(wi.calculate(AlgorithmUtils.createLineGraph(AlgorithmUtils.createLineGraph(AlgorithmUtils.createLineGraph(g))) ) ); 
      ...
      //    v.add(wi.calculate(AlgorithmUtils.createLineGraph(g)));    
         ...
         // Pheriperal Wiener Index Line 2 Graph 
        // v.add(Pw.calculate(AlgorithmUtils.createLineGraph(AlgorithmUtils.createLineGraph(g)) ) ); 
          
          // Pheriperal Wiener Index Line 3 Graph 
         //v.add(Pw.calculate(AlgorithmUtils.createLineGraph(AlgorithmUtils.createLineGraph(AlgorithmUtils.createLineGraph(g))) ) ); 
         
          // Pheriperal Wiener Index Line 4 Graph 
      //   v.add(Pw.calculate(AlgorithmUtils.createLineGraph(AlgorithmUtils.createLineGraph( AlgorithmUtils.createLineGraph(AlgorithmUtils.createLineGraph(g)))  ))   );
    ...
    //    v.add((Integer) new NumOfIndSets().calculate(AlgorithmUtils.createComplementGraph(g)));
         ...
         // v.add(wi.calculate(AlgorithmUtils.createComplementGraph(g)));    
          ...
          // Pheriperal Wiener Index Complement
