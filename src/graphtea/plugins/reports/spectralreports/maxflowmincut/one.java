package graphtea.plugins.reports.spectralreports.maxflowmincut;
import Jama.*; 
...
public class one {
    ...
    */
	   ...
	   A[0][3] = A[1][2] = A[1][3] =  A[2][1] =  A[2][3] =  A[3][0] = A[3][1] = A[3][2] = 1 ;    
	   Matrix M2 = new Matrix(A);
	   
	   EigenvalueDecomposition D = M2.eig();
	   double[] res1 = D.getRealEigenvalues();
	   Matrix V =D.getV();
