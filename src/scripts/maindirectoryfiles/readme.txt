...
In case you have just downloaded and unzipped your GraphLab distribution, 
...
In linux, you can run GraphLab with running the run.sh script.
...
In windows, you can run GraphLab with just double clicking on
graphlab-main.jar file.

License
---------------------------------------

Files in graphlab.library package are distributed under the
