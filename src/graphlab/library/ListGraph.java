...
public class ListGraph<VertexType extends BaseVertex, EdgeType extends BaseEdge<VertexType>>
    ...
    */
    ...
    /* (non-Javadoc)
      * @see graphlab.library.BaseGraph#edgeIterator()
      */
    @Override
...
//				throw new InvalidEdgeException();
    ...
    /* (non-Javadoc)
      * @see graphlab.library.BaseGraph#getEdges(null, null)
      */
    @Override
...
//        return outDegree.get(getId(v)); //todo: outDegree seems not working properly
    ...
    /* (non-Javadoc)
      * @see graphlab.library.BaseGraph#isEdges(null, null)
      */
    @Override
   ...
   @Override
    ...
    /* (non-Javadoc)
      * @see graphlab.library.BaseGraph#createEmptyGraph()
      */
    @Override
    ...
    /* (non-Javadoc)
      * @see graphlab.library.BaseGraph#setDirected(boolean)
      */
    @Override
