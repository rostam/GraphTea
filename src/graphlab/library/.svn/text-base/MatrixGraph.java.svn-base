...
public class MatrixGraph<VertexType extends BaseVertex, EdgeType extends BaseEdge<VertexType>>
    ...
    /* (non-Javadoc)
      * @see graphlab.library.BaseGraph#getVerticesCount()
      */
    @Override
    ...
    /* (non-Javadoc)
      * @see graphlab.library.BaseGraph#insertEdge(null)
      */
    @Override
     ...
     * @throws graphlab.library.exceptions.InvalidVertexException
    ...
    /* (non-Javadoc)
    * @see graphlab.library.BaseGraph#insertVertex(null)
    */
    @Override
    ...
    public boolean depthFirstSearch(VertexType vertex, PreWorkPostWorkHandler<VertexType> handler) throws InvalidVertexException {
        return new graphlab.library.algorithms.traversal.DepthFirstSearch<VertexType, EdgeType>(this)
    ...
    public boolean breadthFirstSearch(VertexType vertex, PreWorkHandler<VertexType> handler) throws InvalidVertexException {
        return new graphlab.library.algorithms.traversal.BreadthFirstSearch<VertexType, EdgeType>(this)
                .doSearch(vertex, handler);
    ...
    */
    ...
    /* (non-Javadoc)
    * @see graphlab.library.BaseGraph#isDirected()
    */
    @Override
    ...
    /* (non-Javadoc)
      * @see graphlab.library.BaseGraph#edgeIterator(null)
      */
    @Override
    ...
    /* (non-Javadoc)
     * @see graphlab.library.BaseGraph#edgeIterator(null, boolean)
     */
   @Override
   public Iterator<EdgeType> edgeIterator(VertexType v, boolean source)
    ...
    /* (non-Javadoc)
    * @see graphlab.library.BaseGraph#getAdjacencyMatrix()
    */
    @Override
    ...
    /* (non-Javadoc)
    * @see graphlab.library.BaseGraph#dump()
    */
    @Override
    public void dump() {
        System.out.print('\n');
    ...
    /* (non-Javadoc)
      * @see graphlab.library.BaseGraph#removeAllEdges(null, null)
      */
    @Override
    ...
    /* (non-Javadoc)
      * @see graphlab.library.BaseGraph#removeVertex(null)
      */
    @Override
    ...
    /* (non-Javadoc)
      * @see graphlab.library.BaseGraph#getInDegree(null)
      */
    @Override
    ...
    /* (non-Javadoc)
      * @see graphlab.library.BaseGraph#getOutDegree(null)
      */
    @Override
    ...
    /* (non-Javadoc)
      * @see graphlab.library.BaseGraph#removeEdge(null)
      */
    @Override
    ...
    /* (non-Javadoc)
      * @see graphlab.library.BaseGraph#copy(graphlab.library.GraphConverter)
      */
    @Override
    ...
    /* (non-Javadoc)
      * @see graphlab.library.BaseGraph#containsVertex(null)
      */
    @Override
    ...
    /* (non-Javadoc)
      * @see graphlab.library.BaseGraph#checkVertex(null)
      */
    @Override
...
//    @Override
    ...
    /* (non-Javadoc)
      * @see graphlab.library.BaseGraph#getVertexArray()
      */
    @Override
    ...
    /* (non-Javadoc)
      * @see graphlab.library.BaseGraph#getEdgeArray()
      */
    @Override
    ...
    /* (non-Javadoc)
      * @see graphlab.library.BaseGraph#lightEdgeIterator()
      */
    @Override
    ...
    /* (non-Javadoc)
      * @see graphlab.library.BaseGraph#lightEdgeIterator(null)
      */
    @Override
    ...
    /* (non-Javadoc)
      * @see graphlab.library.BaseGraph#clear()
      */
    @Override
    public void clear() {
    ...
    /* (non-Javadoc)
     * @see graphlab.library.BaseGraph#weightOfEdge(null, null)
     */
   @Override
