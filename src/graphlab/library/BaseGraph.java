...
abstract public class BaseGraph<VertexType extends BaseVertex, EdgeType extends BaseEdge<VertexType>>
     ...
     * @throws InvalidVertexException
     * @see graphlab.library.BaseGraph#getDegree(BaseVertex)
     */
     ...
     * @see graphlab.library.BaseGraph#lightEdgeIterator(BaseVertex)
     * @see graphlab.library.BaseGraph#getNeighbors(BaseVertex)
     */
     ...
     * @see ListGraph#lightBackEdgeIterator(graphlab.library.BaseVertex)
     */
