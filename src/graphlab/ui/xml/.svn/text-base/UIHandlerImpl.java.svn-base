...
import graphlab.ui.extension.UIActionExtensionAction;
...
public class UIHandlerImpl implements UIHandler, StorableOnExit {
    ...
    Class resourceClass;
    HashMap<String, graphlab.platform.core.AbstractAction> actions = null;
    /**
    ...
    public UIHandlerImpl(GFrame gFrame, BlackBoard bb
            , HashMap<String, graphlab.platform.core.AbstractAction> actions, Class resClass) {
        this.blackboard = bb;
...
//        currentMenu = new JMenu(label);
    ...
    public void handle_menu(final Attributes meta) throws SAXException {
         ...
         */
        graphlab.platform.core.AbstractAction targetAction = actions.get(action);
...
//todo: is it good to remove the action wich loaded twice, (2 of same action are working together)
        ...
        boolean b = false;
        graphlab.platform.core.AbstractAction x = loadAbstractAction(clazz);
...
//            return;
    ...
    private void addAction(String id, graphlab.platform.core.AbstractAction x, String group) {
...
//************** utilities +++++++++++++++++++++
    ...
    AbstractAction loadAbstractAction(String abstractActionclazz) {
        ...
        if (!(clazz == null) && !(clazz.equals(""))) {
            ...
            if (graphlab.platform.core.AbstractAction.class.isAssignableFrom(t)) {
                Object[] o = {blackboard};
                try {
                    Constructor c = t.getConstructor(BlackBoard.class);
                    Object _ = c.newInstance(o);
                    return (graphlab.platform.core.AbstractAction) _;
                }
                catch (Exception e) {
