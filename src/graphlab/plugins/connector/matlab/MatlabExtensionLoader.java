...
package graphlab.plugins.connector.matlab;
...
import graphlab.plugins.connector.ConnectorDS;
import graphlab.plugins.connector.ConnectorReportExtension;
...
//        while (line.startsWith("%")) {
        ...
        {
            ret.command += "{return graphlab.plugins.connector.matlab.MatlabRunner.matlabRunner(new File(\"" + matlabfile.toURI().toURL().getPath() + "\") , " + funcBody + ");}";
        }
