...
public class Plugger {
    ...
    public final String prefix = "graphlab.plugins.";
     ...
     * graphlab.plugins.<i>pluginname</i>.Init, Then the
     * init class of plugin will be loaded.
     * Else if plugin has defined plugin-configxml
     * (or using default =
     * "/graphlab/gui/plugin/<i>pluginname</i>/config.xml"),
     ...
     * @see PluginHandlerInterface#init(String,graphlab.platform.core.BlackBoard)
     */
    public void load(String name) {
        try {
            ...
            try {
                ...
                if (confixml == null)
                    confixml = "/graphlab/plugins/" + name + "/config.xml";
